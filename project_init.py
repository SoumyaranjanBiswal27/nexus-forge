...
def main() -> None:
    ...
    """
    logging.info("--- Starting AI Project Initialization ---")
...
name = "nexus-forge"
version = "0.1.0"
description = "AI Engineering learning projects"
...
# 1. Always use Python 3.11+ syntax and include full type hints.
...
.cursor/
    ...
    if success:
        ...
        logging.info(f"Your project is ready in: {Path(target_project_dir).resolve()}")
    else:
        logging.warning("--- Project initialization completed with warnings (Git failed). ---")
